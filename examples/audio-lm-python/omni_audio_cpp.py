...
def context_default_params() -> omni_context_params:
...
def init_context(params: omni_context_params_p) -> omni_context_p:  # type: ignore
...
# );
def process_full(ctx: omni_context_p, params: omni_context_params_p):  # type: ignore
